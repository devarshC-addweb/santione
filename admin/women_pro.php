...
$q="SELECT * FROM product WHERE cat_name='women'";
					...
					$admin_id=$row['pro_id'];
				  	?>
				  		<tr>
						  	...
						  	<th scope="col"><?php echo $row['pro_description']; ?></th>
						  	<th scope="col"><?php echo $row['in_active']; ?></th>
						  	<th scope="col" class="table-responsive"><?php echo $row['date_time']; ?></th>
						  	<th scope="col"><?php echo $row['ip_server']; ?></th>
						  					  
							<th scope="col">

								<a href="<?php echo "update_admin.php?admin_id=$admin_id";?>"><i class="bi bi-pencil-square hvricon" style="font-size: 1.5rem; color: green; letter-spacing: 1.0rem;"></i></a>
								
								<a href="<?php echo "update_admin.php?admin_id=$admin_id";?>"><i class="bi bi-trash-fill" style="font-size: 1.5rem; color: red; letter-spacing:0.5rem;"></i></a>
