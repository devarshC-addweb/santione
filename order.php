  ...
  <div class="container mt-2" style="background-color:;">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12 " style="background-color:;">
      	<div class="row">
      		...
      		<div class="col-lg-12 col-md-12 col-sm-12 mt-4">
      			<img src="<?php echo 'admin/'.$row['pro_img_1']; ?>" style="width:75%;">
      		</div>
      ...
      <div class="col-lg-6 col-md-12 col-sm-12" style="background-color:; ">
          <div class="row">
          	<div class="col-lg-12 col-md-12 col-sm-12 mt-4">
          		<h4 class="float-start mx-5 fw-bold" style="letter-spacing:3px; font-size:20px ;"><?php echo $row['pro_name']; ?></h4>
          	</div>
          </div>

           <div class="row">
          	<div class="col-lg-12 col-md-12 col-sm-12 mt-3">
          		<h4 class="float-start mx-5 fw-bold" style="letter-spacing:3px; font-size:18px ;"><b class="bw-bold">Rs.</b> <?php echo $row['pro_price']; ?></h4>
          	</div>
          </div>
           ...
           <div class="row">
          	<div class="col-lg-12 col-md-12 col-sm-12 mt-3">
          		<h4 class="float-start mx-5 fw-bold" style="letter-spacing:3px; font-size:18px ;">Women : <?php echo $row['sub_cat_name']; ?></h4>
          	</div>
          </div>
          ...
          <div class="row">
          	<div class="col-lg-12 col-md-12 col-sm-12 mt-3">
          		<h4 class="float-start mx-5 fw-bold" style="letter-spacing: 1px; background: #ebe9e4;">Description:</h4>
          	</div>
          </div>
          <div class="row">
          	<div class="col-lg-12 col-md-12 col-sm-12" style="background-color: ;">
          		<h4 class="float-start mx-5" style="letter-spacing: 1px; font-size:18px ;"><?php echo $row['pro_name']; ?></h4>
          	</div>
          </div>
       ...
       <!--    <center>
          ...
          <div class="row">
          	<div class="col-lg-12 col-md-12 col-sm-12" style="background-color: ;">
          		<form action="orderplace.php?id=<?php echo $id; ?>" method="post">
